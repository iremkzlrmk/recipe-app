...
import com.meri.recipe_app.recipe.IngredientDisplayFragment;
import com.meri.recipe_app.recipe.MakingOfDisplayFragment;
import com.meri.recipe_app.recipe.RecipeDisplayActivity;

import java.util.ArrayList;

public class ChefRecipeDisplayActivity extends AppCompatActivity {
        ...
        buttonStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( isIngredientFragment ){
                    ...
                    Intent intent = new Intent(ChefRecipeDisplayActivity.this, MainActivity.class);
